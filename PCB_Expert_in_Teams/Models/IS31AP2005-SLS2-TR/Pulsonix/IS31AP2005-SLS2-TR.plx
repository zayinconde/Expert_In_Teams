...
//19897254/1780402/2.50/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "IS31AP2005-SLS2-TR" (originalName "IS31AP2005-SLS2-TR")
	...
	(compDef "IS31AP2005-SLS2-TR" (originalName "IS31AP2005-SLS2-TR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "SDB") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "IS31AP2005-SLS2-TR"))
		...
		(attr "Manufacturer_Part_Number" "IS31AP2005-SLS2-TR")
		(attr "Description" "2.95W Mono Filter-less Class-D Audio Power Amplifier, MSOP-8 (3.0mm x 5.0mm), T&R")
		(attr "<Hyperlink>" "https://www.lumissil.com/assets/pdf/core/IS31AP2005_DS.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "IS31AP2005-SLS2-TR.stp")
