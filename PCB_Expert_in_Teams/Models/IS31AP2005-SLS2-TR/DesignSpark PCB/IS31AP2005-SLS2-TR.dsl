...
(library Library_1
	...
	(compDef "IS31AP2005-SLS2-TR" (originalName "IS31AP2005-SLS2-TR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "SDB") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.lumissil.com/assets/pdf/core/IS31AP2005_DS.pdf")
		(attr "Height" "1.1 mm")
	)
