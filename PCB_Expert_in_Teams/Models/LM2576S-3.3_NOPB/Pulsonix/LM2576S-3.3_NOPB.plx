...
(library Library_1
	...
	(symbolDef "LM2576S-3.3_NOPB" (originalName "LM2576S-3.3_NOPB")
	...
	(compDef "LM2576S-3.3_NOPB" (originalName "LM2576S-3.3_NOPB") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LM2576S-3.3_NOPB"))
		...
		(attr "<Hyperlink>" "http://www.ti.com/lit/ds/symlink/lm2576.pdf")
		(attr "<Component Height>" "4.65")
		(attr "<STEP Filename>" "LM2576S-3.3_NOPB.stp")
